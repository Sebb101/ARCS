...
class Ui(QtWidgets.QMainWindow):
    ...
    def start_NIbutton_action(self):
        ...
        if(not self.readingState):
            ...
            self.NIdisplay_worker = displayWorker()

            # Step 4: Move worker to the thread
            self.volt_cur_reader_worker.moveToThread(self.volt_cur_readingthread)
            self.NIdisplay_worker.moveToThread(self.displaythread)
            ...
            self.display_worker.outgoing_PTdata.connect(self.volt_cur_append_incoming_data)
